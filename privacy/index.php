    ...
    <main role="main">
      ...
      <div class="container">
        <div class="row mt-3">
          <div class="col-sm">
            <h1>Privacy</h1>
            <p>We hate getting spam, don’t you? We only ask our users for data that’s essential to providing a fantastic learning experience, and we only send you marketing if you ask us to.</p>
            <p>The Online Centre for Religious Studies (OCRS) will only collect information about you for the purpose of our legitimate interests, these include:</p>
            <ul>
              <li>setting up online learning accounts</li>
              <li>delivering online courses</li>
